...
extern const String SECRET_SSID = "El FabSpace Lac";    // unless PIN is deactivated, specify your SIM card PIN number
extern const String SECRET_WIFI_PASS = "Think_Make_Share";          // specify the APN name (if needed)
...
extern const String SECRET_LIVEOBJECTS_API_KEY = "8baf176f0bf64725a88feb59ccd7636a";
